...
class SettingsBloc extends Bloc<SettingsEvent, SettingsState> {
  ...
  Future<void> _onLoadSettings(
    ...
    try {
      ...
      AppTextScale.set(_settingsService.fontSizeMultiplier);
    } catch (e) {
      emit(
        state.copyWith(
          isLoading: false,
  ...
  Future<void> _onUpdateFontSize(
    ...
    emit(state.copyWith(fontSizeMultiplier: event.fontSizeMultiplier));
  }
  ...
  Future<void> _onUpdateUiScale(
    ...
    // Just update the state without saving to SharedPreferences
    emit(state.copyWith(uiScaleMultiplier: event.uiScaleMultiplier));
  }
  ...
  Future<void> _onUpdateDownloadPath(
    ...
    // Just update the state without saving to SharedPreferences
    emit(state.copyWith(downloadPath: event.downloadPath));
  }
  ...
  Future<void> _onApplyPreset(
    ...
    try {
      ...
      AppTextScale.set(event.fontSizeMultiplier);
    } catch (e) {
      emit(
        state.copyWith(
          isSaving: false,
  ...
  Future<void> _onSubmitSettings(
    ...
    try {
      ...
      AppTextScale.set(state.fontSizeMultiplier);
