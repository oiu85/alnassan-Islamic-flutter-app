...
class PopularAdvisoriesWidget extends StatelessWidget {
  const PopularAdvisoriesWidget({super.key});
  ...
  Widget _buildContent(BuildContext context, AdvisoryState state) {
    if (state.popularStatus.isLoading()) {
      return Container(
        height: ScreenUtil().setHeight(200),
        child: Center(
          child: Lottie.asset(
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              Text(
                state.popularError ?? 'حدث خطأ في تحميل الفتاوى',
                style: TextStyle(
                  fontFamily: FontFamily.tajawal,
    ...
    if (state.popularAdvisories.isEmpty) {
      return Container(
        height: ScreenUtil().setHeight(200),
        child: Center(
          child: Column(
    ...
    final displayAdvisories = state.popularAdvisories.take(3).toList();
