...
import '../../data/model.dart'; // Import for AlmawdueaArticleDetailModel
import 'almawduea_event.dart';
import 'almawduea_state.dart';
// ===== HTML VIEWER IMPORTS =====
import '../../../html_viewer/domain/models/html_content.dart';

class AlmawdueaBloc extends Bloc<AlmawdueaEvent, AlmawdueaState> {
  final AlmawdueaRepository _almawdueaRepository;

  AlmawdueaBloc(this._almawdueaRepository) : super(const AlmawdueaState()) {
    on<FetchAlmawdueaArticlesEvent>(_onFetchAlmawdueaArticles);
  ...
  /// Converts AlmawdueaArticleDetailModel to HtmlContent for the HTML viewer
  HtmlContent _mapArticleDetailToHtmlContent(AlmawdueaArticleDetailModel articleDetail) {
  ...
  Future<void> _onFetchAlmawdueaArticles(
  ...
  Future<void> _onChangePage(
    ...
    add(FetchAlmawdueaArticlesEvent(
      categoryId: event.categoryId,
      page: event.page,
      perPage: event.perPage,
    ));
